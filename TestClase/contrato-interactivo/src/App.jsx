...
const clausulasContrato = [
  ...
  { id: 'c3', titulo: "CLÁUSULA TERCERA. HONORARIOS", contenido: "EL CONTRATANTE pagará a EL CONTRATISTA la suma de VEINTITRÉS MILLONES DE PESOS M/CTE ($23.000.000), un salario integral, por la ejecución total de la obra. Dentro de este valor no se incluyen viáticos de ningún tipo." },
  ...
  { id: 'c5', titulo: "CLÁUSULA SEXTA. CONFIDENCIALIDAD", contenido: "EL CONTRATISTA se obliga a mantener en estricta reserva y no divulgar a terceros la información técnica, comercial, lógica interna de la marca, guiones, ni el código fuente del proyecto. Queda expresamente prohibida la publicación del código fuente en repositorios públicos, plataformas de portafolio o cualquier otro medio, durante un tiempo de 10 años." },
  { id: 'c6', titulo: "CLÁUSULA SÉPTIMA. COMPETENCIA DESLEAL", contenido: "EL CONTRATISTA no podrá adaptar, modificar, revender ni licenciar el software desarrollado (ni versiones alteradas del mismo mediante cambios estéticos, de color o de logotipos) a marcas de la competencia ni a ningún tercero, durante un tiempo de 10 años." },
  { id: 'c7', titulo: "CLÁUSULA OCTAVA. SANCIONES", contenido: "El incumplimiento de cualquiera de las obligaciones dará lugar a la terminación inmediata del contrato y al cobro de una sanción pecuniaria equivalente a VEINTE MILLONES DE PESOS M/CTE ($20.000.000), sin perjuicio de las acciones legales correspondientes." },
  { id: 'c8', titulo: "CLÁUSULA NOVENA. VIÁTICOS", contenido: "Los gastos por concepto de viáticos, registrales y cualquier otro gasto conexo no se entenderá comprendido en los honorarios. Serán asumidos en su totalidad por la EMPRESA. El CONTRATANTE estará obligado a reportar la totalidad de los gastos aportando los soportes idóneos." }
];
